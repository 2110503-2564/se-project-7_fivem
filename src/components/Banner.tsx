  ...
  return (
    <div className={`${styles.Banner} relative w-screen h-screen`}>
      ...
      <div className="absolute top-8 left-8 opacity-40">
        <Trees className="h-16 w-16 text-green-100" />
      </div>
      <div className="absolute top-12 right-12 opacity-40">
        <Mountain className="h-20 w-20 text-green-100" />
      </div>
      ...
      <div className={styles.BannerText}>
        ...
        <h3 className='text-xl text-green-100 max-w-2xl text-center drop-shadow-md leading-relaxed'>
      ...
      <button
  className='z-30 mt-8 bg-green-600 hover:bg-green-700 text-green-50 font-medium py-3 px-6 rounded-full shadow-lg transition-all duration-300 hover:scale-105 flex items-center gap-2 border border-green-800'
  onClick={(e) => {
